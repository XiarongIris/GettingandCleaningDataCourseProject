...
#Project R Script
#change the current direction to the folder with UCI HAR Dataset
#setwd("C:\Users\xis11003\Dropbox\Iris_Course2015-2016\JPU_Data scientist specialization\Course 3 Getting and Cleaning Data\Project\getdata-projectfiles-UCI HAR Dataset\UCI HAR Dataset")
